...
bcf INTCON,0
BANKSEL OSCCON
movlw 0b01100101 ;4Mhz ((PORTB) and 07Fh), 6
movwf OSCCON
retfie
...
bcf INTCON,0
BANKSEL OSCCON
movlw 0b01010101 ;2Mhz ((PORTB) and 07Fh), 5
movwf OSCCON
retfie
...
bcf INTCON,0
BANKSEL OSCCON
movlw 0b01000101 ;1Mhz ((PORTB) and 07Fh), 4
movwf OSCCON
retfie
...
bcf INTCON,0
BANKSEL OSCCON
movlw 0b00110101 ;500khz ((PORTB) and 07Fh), 3
movwf OSCCON
retfie
...
bcf INTCON,0
BANKSEL OSCCON
movlw 0b00100101 ;250kHz ((PORTB) and 07Fh), 2
movwf OSCCON
retfie
...
bcf INTCON,0
BANKSEL OSCCON
movlw 0b00010101 ;125kHz ((PORTB) and 07Fh), 1
movwf OSCCON
retfie
isr2:
   BANKSEL PORTB
   ...
   goto isr
     bcf INTCON,0
     BANKSEL OSCCON
     movlw 0b00000011 ;31kHz ((PORTB) and 07Fh), 0
     movwf OSCCON
   retfie
...
isr:
    ...
    retfie
    BANKSEL OSCCON
    movlw 0b01110101 ; se pone a 8Mhz, ((PORTB) and 07Fh), 7 trabaja con el interno y es el alto es decir trabaja con el reloj interno y en alta frecuencia y este mismo se utiliza como reloj interno
    movwf OSCCON
    BANKSEL PORTC
    movlw 0b10000000
    movwf PORTC
